...
class AdminController extends Controller
{
    ...
    public function delete_user($id)
    {
        ...
        if($user->exists()){
            ...
            foreach($user->all_posts_user as $item){
            
                foreach($item->all_images_carousel() as $image){
                    if(is_file('storage/app/public/images/'.$image->file_name)){
                        $delete_image = File::delete('storage/app/public/images/'.$image->file_name);
                    }

                    if(is_file('storage/app/public/images/thumbnail/'.$image->file_name)){
                        $delete_thumb = File::delete('storage/app/public/images/thumbnail/'.$image->file_name);
                    }
                }
